...
const isTauri = Boolean(process.env.TAURI_PLATFORM || process.env.IS_TAURI === 'true');
    ...
    return [
      {
        ...
        headers: [
          ...
          },
          {
            ...
            value: "default-src 'self'; script-src 'self' 'unsafe-eval' 'unsafe-inline' blob: https://cdn.jsdelivr.net https://paystack.com https://paystack.co https://js.paystack.co https://*.paystack.co https://*.paystack.com https://code.iconify.design https://*.iconify.design https://*.google.com https://*.googleapis.com https://*.gstatic.com https://*.vercel-insights.com https://*.vercel-scripts.com https://va.vercel-scripts.com https://*.smartsuppchat.com https://connect.facebook.net https://*.tiktok.com https://*.tiktokw.us https://analytics.tiktok.com https://static.ads-twitter.com https://www.googletagmanager.com https://*.dodopayments.com https://checkout.flutterwave.com https://*.flutterwave.com; script-src-elem 'self' 'unsafe-inline' blob: https://cdn.jsdelivr.net https://paystack.com https://paystack.co https://js.paystack.co https://*.paystack.co https://*.paystack.com https://code.iconify.design https://*.iconify.design https://*.google.com https://*.googleapis.com https://*.gstatic.com https://*.vercel-insights.com https://*.vercel-scripts.com https://va.vercel-scripts.com https://*.smartsuppchat.com https://connect.facebook.net https://*.tiktok.com https://*.tiktokw.us https://analytics.tiktok.com https://static.ads-twitter.com https://www.googletagmanager.com https://*.dodopayments.com https://checkout.flutterwave.com https://*.flutterwave.com; worker-src 'self' blob:; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://paystack.com https://*.paystack.com https://*.paystack.co https://js.paystack.co; style-src-elem 'self' 'unsafe-inline' https://fonts.googleapis.com https://paystack.com https://*.paystack.com https://*.paystack.co https://js.paystack.co; font-src 'self' data: https://fonts.gstatic.com; img-src 'self' data: https: blob: https://*.firebaseapp.com https://*.unsplash.com; media-src 'self' blob: data: https://*.cloudinary.com https://*.youtube.com https://*.youtube-nocookie.com https://assets.mixkit.co; connect-src 'self' https://ipapi.co https://freeipapi.com https://ipwho.is https://api.db-ip.com https://zeneva.space https://*.zeneva.space https://paystack.com https://paystack.co https://*.paystack.com https://*.paystack.co https://api.paystack.co https://*.googleapis.com https://*.firebaseio.com https://*.firebaseapp.com https://*.google-analytics.com https://www.google.com https://*.google.com https://*.vercel-insights.com https://*.chowdeck.com https://*.ibb.co https://api.imgbb.com https://*.cloudinary.com https://fonts.googleapis.com https://fonts.gstatic.com https://*.iconify.design https://api.iconify.design https://*.facebook.com https://*.tiktok.com https://*.tiktokw.us https://*.smartsuppchat.com https://*.dodopayments.com https://api.github.com https://api.emailjs.com https://*.unsplash.com https://api.flutterwave.com https://*.flutterwave.com https://checkout.flutterwave.com https://api.ravepay.co https://*.ravepay.co; frame-src 'self' blob: data: https://checkout.paystack.com https://js.paystack.co https://*.paystack.com https://*.paystack.co https://*.firebaseapp.com https://www.youtube.com https://*.youtube.com https://www.youtube-nocookie.com https://*.youtube-nocookie.com https://checkout.dodopayments.com https://*.dodopayments.com https://checkout.flutterwave.com https://*.flutterwave.com; frame-ancestors 'self';",
          },
          {
