...
const en = {
  ...
  auth: {
    ...
    loginSlide1Desc: 'Streamline your operations, maximize your profit, and build lasting customer relationships.',
    loginSlide2Title: 'Precision Analytics',
    loginSlide2Desc: 'Real-time insights tailored for high-growth business environments.',
    ...
    signupSubtitle: 'Join growing businesses on Zen Office.',
    ...
    signupSlide3Desc: "Scale from a single location to a global franchise with Zen Office's multi-branch intelligence.",
    signupSlide4Title: 'Unified Operations',
    signupSlide4Desc: 'Manage your operations with absolute ease and grow without boundaries.',
    // --- Forgot password ---
