...
const en = {
  ...
  auth: {
    ...
    welcomeSlide1: 'Welcome to the ultimate\ndocument workspace',
    welcomeSlide2: 'Seamlessly read & edit\nPDFs, Word & Excel',
    welcomeSlide3: 'Manage documents\nwith absolute ease',
    welcomeSlide4: 'One unified suite,\nwherever you work',
    ...
    loginSlide1Title: 'All-in-One Office & Document Suite',
    loginSlide1Desc: 'Streamline your document workflow, view PDFs, edit spreadsheets, and stay organized.',
    loginSlide2Title: 'Document Intelligence & Analytics',
    loginSlide2Desc: 'Smart document insights and lightning-fast search tailored for your workspace.',
    loginSlide3Title: 'Work From Anywhere',
    loginSlide3Desc: 'Secure, local-first and cloud access that puts your documents in the palm of your hand.',
    // --- Signup ---
    signupTitle: 'Create an account',
    signupSubtitle: 'Get started with the Zen Office document suite.',
    ...
    signupSlide1Title: 'Seamless Document Management',
    signupSlide1Desc: 'Read, edit, annotate, and organize all your PDFs, Word documents, and spreadsheets in one place.',
    signupSlide2Title: 'Powerful Office Suite',
    signupSlide2Desc: 'Advanced PDF editing, Excel spreadsheet tools, and smart document reading built for modern workflows.',
    signupSlide3Title: 'Cloud & Local Synchronization',
    signupSlide3Desc: 'Access your documents offline or sync seamlessly across your devices with encrypted cloud vault security.',
    signupSlide4Title: 'Unified Workspace',
    signupSlide4Desc: 'Manage your documents with absolute ease and organize your files without boundaries.',
    // --- Forgot password ---
